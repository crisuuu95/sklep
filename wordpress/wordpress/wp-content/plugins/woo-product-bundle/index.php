...
! defined( 'WOOSB_VERSION' ) && define( 'WOOSB_VERSION', '3.4.4' );
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
                                                ...
                                                <input type="hidden" name="page_options"
                                                       value="_woosb_price_format,_woosb_price_sync,_woosb_bundled_thumb,_woosb_bundled_qty,_woosb_bundled_description,_woosb_bundled_price,_woosb_bundled_link,_woosb_change_image,_woosb_hide_bundle_name,_woosb_hide_bundled,_woosb_hide_bundled_mini_cart,_woosb_bundle_price_text,_woosb_archive_button_add,_woosb_archive_button_select,_woosb_archive_button_read,_woosb_single_button_add,_woosb_search_limit,_woosb_search_sku,_woosb_search_exact,_woosb_search_sentence,_woosb_search_same,_woosb_method"/>
                                            </th>
                                        </tr>
                                    </table>
                                </form>
							...
							if ( self::woosb_ready_add_to_cart( $items ) ) {
								...
								foreach ( $items as $item ) {
									...
									if ( ( $woosb_item_id > 0 ) && ( $woosb_item_qty > 0 ) ) {
										...
										$woosb_item_key    = WC()->cart->add_to_cart( $woosb_item_id, $woosb_product_qty, $woosb_item_variation_id, $woosb_item_variation, array(
											'woosb_pos'        => $woosb_i,
