...
function wptf_shortcode_generator($atts = false) {
    ...
    if( isset( $atts['id'] ) && !empty( $atts['id'] ) && is_numeric( $atts['id'] ) && get_post_type( (int) $atts['id'] ) == 'wptf_product_table' ){
        $ID = (int) $atts['id'];
        ...
        $table_column_title = !isset( $column_settings['table_head'] ) ? array_values( $enabled_column_array ) : false;
