...
(function($) {
	...
	var $supports_html5_storage = true,
        ...
        console.log(cart_hash_key);
        console.log(wc_cart_fragments_params);
        //wc_fragments_loaded
        //******************Testing work End Here*************/
        
        $('body').on('click','h1.entry-title',function(){
            new_setFragmentsRefresh();
        });
        function new_setFragmentsRefresh(){
            $.ajax({
                type: 'POST',
        ...
        /*
        //Temporary Removed from 3.7.6 version
        ...
        */
        ...
        $('body').on('change','td.data_product_variations .wptf_varition_section',function() {
            ...
            var target_class = '.wptf_action_' + product_id;
